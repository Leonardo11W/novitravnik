...
class Best2 extends StatefulWidget {
  const Best2({Key? key}) : super(key: key);

  @override
  _Best2State createState() => _Best2State();
}

class _Best2State extends State<Best2> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16908750642459, 17.65395206427791),
  ];
