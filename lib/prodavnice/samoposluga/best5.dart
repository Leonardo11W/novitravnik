...
class Best5 extends StatefulWidget {
  const Best5({Key? key}) : super(key: key);

  @override
  _Best4State createState() => _Best4State();
}

class _Best4State extends State<Best5> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  Best5Data data = Best5Data();
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Fra Marijana Šunjića'
                                        : (English == true)
                                            ? "Address: Fra Marijana Šunjića"
                                            : "die Anschrift: Fra Marijana Šunjića",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
