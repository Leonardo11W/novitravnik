...
class Best3 extends StatefulWidget {
  const Best3({Key? key}) : super(key: key);

  @override
  _Best3State createState() => _Best3State();
}

class _Best3State extends State<Best3> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  Best3Data data = Best3Data();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17710163575821, 17.663823599401752),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/best3.png',
