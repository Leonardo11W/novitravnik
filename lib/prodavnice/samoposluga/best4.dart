...
class Best4 extends StatefulWidget {
  const Best4({Key? key}) : super(key: key);

  @override
  _Best4State createState() => _Best4State();
}

class _Best4State extends State<Best4> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  Best4Data data = Best4Data();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.bestici3.length; i++) {
      double storelat = data.bestici3[i]['lat'];
      double storelng = data.bestici3[i]['lng'];
      ...
      data.bestici3[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17407920094797, 17.662321990804646),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/best4.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  (BHS == true)
                                      ? "${data.bestici3[0]['distance'].round()} m udaljeno"
                                      : (English == true)
                                          ? "${data.bestici3[0]['distance'].round()} m away"
                                          : "${data.bestici3[0]['distance'].round()} m weg",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
