...
class Frutty extends StatefulWidget {
  const Frutty({Key? key}) : super(key: key);

  @override
  _fruttyState createState() => _fruttyState();
}

class _fruttyState extends State<Frutty> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  fruttyData data = fruttyData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17425083352737, 17.662490867064008),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/frutty.png',
