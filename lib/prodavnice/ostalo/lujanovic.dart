...
class Lujanovic extends StatefulWidget {
  const Lujanovic({Key? key}) : super(key: key);

  @override
  _LujanovicState createState() => _LujanovicState();
}

class _LujanovicState extends State<Lujanovic> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  LujanovicData data = LujanovicData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17268917103481, 17.66234012942575),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/lujanovic.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 09:30/18'
                                      : (English == true)
                                          ? "Working hours: 09:30/18"
                                          : "Arbeitszeit: 09:30/18",
