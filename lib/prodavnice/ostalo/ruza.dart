...
class Ruza extends StatefulWidget {
  const Ruza({Key? key}) : super(key: key);

  @override
  _ruzaState createState() => _ruzaState();
}

class _ruzaState extends State<Ruza> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  RuzaData data = RuzaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.174332685969475, 17.66344347487986),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/ruza.png',
