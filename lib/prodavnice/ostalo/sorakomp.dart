...
class Sorakomp extends StatefulWidget {
  const Sorakomp({Key? key}) : super(key: key);

  @override
  _SorakompState createState() => _SorakompState();
}

class _SorakompState extends State<Sorakomp> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  sorakompData data = sorakompData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17105526316042, 17.642932531203236),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/sonakomp.png',
