...
class Dugatehna extends StatefulWidget {
  const Dugatehna({Key? key}) : super(key: key);

  @override
  _DugatehnaState createState() => _DugatehnaState();
}

class _DugatehnaState extends State<Dugatehna> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DugatehnaData data = DugatehnaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17485421906819, 17.66297797297374),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/dugatehna.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ive Andrića 31'
                                        : (English == true)
                                            ? "Address: Ive Andrića 31"
                                            : "die Anschrift: Ive Andrića 31",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
