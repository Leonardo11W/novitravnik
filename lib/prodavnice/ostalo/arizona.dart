...
class Arizona extends StatefulWidget {
  const Arizona({Key? key}) : super(key: key);

  @override
  _ArizonaState createState() => _ArizonaState();
}

class _ArizonaState extends State<Arizona> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  arizonaData data = arizonaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16904728975522, 17.6527158784599),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/arizona.png',
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ? "Address: Mehmeda Spahe 5"
                                            : "die Anschrift: Mehmeda Spahe 5",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
