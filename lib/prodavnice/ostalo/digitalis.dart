...
class Digitalis extends StatefulWidget {
  const Digitalis({Key? key}) : super(key: key);

  @override
  _DigitalisState createState() => _DigitalisState();
}

class _DigitalisState extends State<Digitalis> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DigitalisData data = DigitalisData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17790081824496, 17.66502162822638),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/digitalis.png',
