...
class clm extends StatefulWidget {
  const clm({Key? key}) : super(key: key);

  @override
  _clmState createState() => _clmState();
}

class _clmState extends State<clm> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  clmData data = clmData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.178894046996916, 17.66653663837456),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/clm.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 8:30/17'
                                      : (English == true)
                                          ? "Working hours: 8:30/17"
                                          : "Arbeitszeit: 8:30/17",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Stjepana Tomaševića 23'
                                        : (English == true)
                                            ? "Address: Stjepana Tomaševića 23"
                                            : "die Anschrift: Stjepana Tomaševića 23",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
