...
class Eurodom extends StatefulWidget {
  const Eurodom({Key? key}) : super(key: key);

  @override
  _EurodomState createState() => _EurodomState();
}

class _EurodomState extends State<Eurodom> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  EurodomData data = EurodomData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.178697366266995, 17.66602790984528),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/eurodom.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 7:30/16'
                                      : (English == true)
                                          ? "Working hours: 7:30/16"
                                          : "Arbeitszeit: 7:30/16",
