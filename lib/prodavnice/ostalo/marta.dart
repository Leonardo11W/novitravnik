...
class Marta extends StatefulWidget {
  const Marta({Key? key}) : super(key: key);

  @override
  _MartaState createState() => _MartaState();
}

class _MartaState extends State<Marta> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  MartaData data = MartaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17649651816336, 17.6630164612079),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/marta.png',
