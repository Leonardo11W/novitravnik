...
class Sabelja extends StatefulWidget {
  const Sabelja({Key? key}) : super(key: key);

  @override
  _SabeljaState createState() => _SabeljaState();
}

class _SabeljaState extends State<Sabelja> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  sabeljaData data = sabeljaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17371927357014, 17.658849904922644),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/sabelja.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Fra Marijana Šunjića 11b'
                                        : (English == true)
                                            ? "Address: Fra Marijana Šunjića 11b"
                                            : "die Anschrift: Fra Marijana Šunjića 11b",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
