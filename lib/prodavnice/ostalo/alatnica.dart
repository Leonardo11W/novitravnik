...
class Alatnica extends StatefulWidget {
  const Alatnica({Key? key}) : super(key: key);

  @override
  _AlatnicaState createState() => _AlatnicaState();
}

class _AlatnicaState extends State<Alatnica> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  alatnicaData data = alatnicaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.18014867837606, 17.668667383384218),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/alatnica.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 7:30/19'
                                      : (English == true)
                                          ? "Working hours: 7:30/19"
                                          : "Arbeitszeit: 7:30/19",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Stjepana Tomaševića 87'
                                        : (English == true)
                                            ? "Address: Stjepana Tomaševića 87"
                                            : "die Anschrift: Stjepana Tomaševića 87",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
