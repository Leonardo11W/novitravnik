...
import 'package:novi_travnik/prodavnice/ostalo/ostalopdata.dart';
import 'package:novi_travnik/prodavnice/prodavnice.dart';

import 'package:novi_travnik/search.dart';

class OstaloProdavnice extends StatefulWidget {
  const OstaloProdavnice({Key? key}) : super(key: key);

  @override
  _OstaloProdavniceState createState() => _OstaloProdavniceState();
}

class _OstaloProdavniceState extends State<OstaloProdavnice> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  OstaloPData data = OstaloPData();
