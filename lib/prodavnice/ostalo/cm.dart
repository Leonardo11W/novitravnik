...
class Cm extends StatefulWidget {
  const Cm({Key? key}) : super(key: key);
...
class _CmState extends State<Cm> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.171871646940765, 17.661731422713743),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/cm.png',
