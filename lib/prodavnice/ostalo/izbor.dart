...
class Izbortrgovine extends StatefulWidget {
  const Izbortrgovine({Key? key}) : super(key: key);

  @override
  _IzbortrgovineState createState() => _IzbortrgovineState();
}

class _IzbortrgovineState extends State<Izbortrgovine> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  IzbortrgovineData data = IzbortrgovineData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.172008238132406, 17.66210961417882),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/izbor.png',
