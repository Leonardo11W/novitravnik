...
class Agrotrade extends StatefulWidget {
  const Agrotrade({Key? key}) : super(key: key);

  @override
  _AgrotradeState createState() => _AgrotradeState();
}

class _AgrotradeState extends State<Agrotrade> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  AgrotradeData data = AgrotradeData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17606890591719, 17.662175240504844),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/agrotrade.png',
