...
class Aminostore extends StatefulWidget {
  const Aminostore({Key? key}) : super(key: key);

  @override
  _aminostoreState createState() => _aminostoreState();
}

class _aminostoreState extends State<Aminostore> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  aminostoreData data = aminostoreData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.169288832655056, 17.644639656408067),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/aminostore.png',
