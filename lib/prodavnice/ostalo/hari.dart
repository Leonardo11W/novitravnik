...
class Hari extends StatefulWidget {
  const Hari({Key? key}) : super(key: key);
...
class _HariState extends State<Hari> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.169025249244996, 17.651180183508902),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/hari.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Mehmeda Spahe 3H'
                                        : (English == true)
                                            ? "Address: Mehmeda Spahe 3H"
                                            : "die Anschrift: Mehmeda Spahe 3H",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
