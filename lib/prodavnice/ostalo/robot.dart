...
class _RobotState extends State<Robot> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17622543623092, 17.665690716762438),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/robot.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ivana Meštrovića 21'
                                        : (English == true)
                                            ? "Address: Ivana Meštrovića 21"
                                            : "die Anschrift: Ivana Meštrovića 21",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
