...
class _nandaState extends State<nanda> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16869570008861, 17.65194536930847),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/n&a.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Mehmeda Spahe 3D'
                                        : (English == true)
                                            ? "Address: Mehmeda Spahe 3D"
                                            : "die Anschrift: Mehmeda Spahe 3D",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
