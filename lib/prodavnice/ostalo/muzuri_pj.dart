...
class muzuri extends StatefulWidget {
  const muzuri({Key? key}) : super(key: key);

  @override
  _muzuriState createState() => _muzuriState();
}

class _muzuriState extends State<muzuri> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  muzuriData data = muzuriData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17924198933044, 17.667053235759397),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/muzuri.png',
