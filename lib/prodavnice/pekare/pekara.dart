...
class Pekara extends StatefulWidget {
  const Pekara({Key? key}) : super(key: key);

  @override
  _PekaraState createState() => _PekaraState();
}

class _PekaraState extends State<Pekara> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16866517299827, 17.65324962952416),
  ];
