...
import 'package:novi_travnik/prodavnice/pekare/pekaredata.dart';
import 'package:novi_travnik/prodavnice/prodavnice.dart';

import 'package:novi_travnik/search.dart';

class Pekare extends StatefulWidget {
  const Pekare({Key? key}) : super(key: key);

  @override
  _PekareState createState() => _PekareState();
}

class _PekareState extends State<Pekare> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  PekareData data = PekareData();
