...
class Klas extends StatefulWidget {
  const Klas({Key? key}) : super(key: key);

  @override
  _KlasState createState() => _KlasState();
}

class _KlasState extends State<Klas> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.174386818044105, 17.662804562800755),
  ];
