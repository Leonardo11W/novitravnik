...
import 'package:novi_travnik/prodavnice/pekare/pekareposebno.dart';
import 'package:novi_travnik/search.dart';

import 'package:geolocator/geolocator.dart';

class Mlinpek extends StatefulWidget {
  const Mlinpek({Key? key}) : super(key: key);

  @override
  _MlinpekState createState() => _MlinpekState();
}

class _MlinpekState extends State<Mlinpek> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  MlinpekData data = MlinpekData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17526963569837, 17.662811681397237),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/randompekara.png',
