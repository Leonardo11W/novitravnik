...
class Inovine1 extends StatefulWidget {
  const Inovine1({Key? key}) : super(key: key);

  @override
  _InovineState1 createState() => _InovineState1();
}

class _InovineState1 extends State<Inovine1> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  iNovineData1 data = iNovineData1();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17094567951777, 17.659268565093438),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine.png',
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka 18"
                                            : "die Anschrift: Kralja Tvrtka 18",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
