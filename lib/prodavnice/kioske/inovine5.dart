...
class Inovine5 extends StatefulWidget {
  const Inovine5({Key? key}) : super(key: key);

  @override
  _InovineState5 createState() => _InovineState5();
}

class _InovineState5 extends State<Inovine5> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  iNovineData5 data = iNovineData5();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.168881920817405, 17.65291493753434),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine5.png',
