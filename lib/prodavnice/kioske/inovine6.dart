...
class Inovine6 extends StatefulWidget {
  const Inovine6({Key? key}) : super(key: key);

  @override
  _InovineState6 createState() => _InovineState6();
}

class _InovineState6 extends State<Inovine6> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.168132238150356, 17.651264509918303),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine6.png',
