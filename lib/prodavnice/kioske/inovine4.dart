...
class Inovine4 extends StatefulWidget {
  const Inovine4({Key? key}) : super(key: key);

  @override
  _InovineState4 createState() => _InovineState4();
}

class _InovineState4 extends State<Inovine4> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  iNovineData3 data = iNovineData3();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.170291745777796, 17.657713503068063),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine4.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Kralja Tvrtka 10A'
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka 10A"
                                            : "die Anschrift: Kralja Tvrtka 10A",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
