...
class Inovine3 extends StatefulWidget {
  const Inovine3({Key? key}) : super(key: key);

  @override
  _InovineState3 createState() => _InovineState3();
}

class _InovineState3 extends State<Inovine3> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.1746444253029, 17.66301256678221),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine3.png',
