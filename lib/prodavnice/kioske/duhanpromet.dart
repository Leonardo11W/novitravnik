...
import 'package:novi_travnik/prodavnice/kioske/kiosciposebno.dart';
...
class Duhanpromet extends StatefulWidget {
  const Duhanpromet({Key? key}) : super(key: key);

  @override
  _DuhanprometState createState() => _DuhanprometState();
}

class _DuhanprometState extends State<Duhanpromet> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DuhanprometData data = DuhanprometData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16875011355526, 17.654035342535256),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/duhanpromet.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 06/20:30'
                                      : (English == true)
                                          ? "Working hours: 06/20:30"
                                          : "Arbeitszeit: 06/20:30",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Trg Federacije'
                                        : (English == true)
                                            ? "Address: Trg Federacije"
                                            : "die Anschrift: Trg Federacije",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
