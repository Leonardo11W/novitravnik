...
class Inovine2 extends StatefulWidget {
  const Inovine2({Key? key}) : super(key: key);

  @override
  _InovineState2 createState() => _InovineState2();
}

class _InovineState2 extends State<Inovine2> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  iNovineData2 data = iNovineData2();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.172235388299505, 17.661939217571813),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/inovine2.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ive Andrića bb'
                                        : (English == true)
                                            ? "Address: Ive Andrića bb"
                                            : "die Anschrift: Ive Andrića bb",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
