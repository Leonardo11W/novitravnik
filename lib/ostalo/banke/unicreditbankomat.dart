...
class Unicreditbankomat extends StatefulWidget {
  const Unicreditbankomat({Key? key}) : super(key: key);

  @override
  _UnicreditbankomatState createState() => _UnicreditbankomatState();
}

class _UnicreditbankomatState extends State<Unicreditbankomat> {
  ...
  UnicreditbankomatData data = UnicreditbankomatData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.170232475216494, 17.65691401131171),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/unicredit.png',
