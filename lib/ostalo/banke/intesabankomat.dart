...
class Intesa2 extends StatefulWidget {
  const Intesa2({Key? key}) : super(key: key);

  @override
  _IntesaState2 createState() => _IntesaState2();
}

class _IntesaState2 extends State<Intesa2> {
  ...
  IntesaBankomatData data = IntesaBankomatData();
