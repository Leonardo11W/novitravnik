...
class Unicredit extends StatefulWidget {
  const Unicredit({Key? key}) : super(key: key);

  @override
  _UnicreditState createState() => _UnicreditState();
}

class _UnicreditState extends State<Unicredit> {
  ...
  UnicreditData data = UnicreditData();
