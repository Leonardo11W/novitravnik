...
import 'package:novi_travnik/ostalo/banke/bankedata.dart';
...
class Banke extends StatefulWidget {
  const Banke({Key? key}) : super(key: key);

  @override
  _BankeState createState() => _BankeState();
}

class _BankeState extends State<Banke> {
  Future<bool> _exit() async {
    return (await Navigator.push(
            context, MaterialPageRoute(builder: (context) => Ostalo()))) ??
        false;
  }

  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  BankeData data = BankeData();
