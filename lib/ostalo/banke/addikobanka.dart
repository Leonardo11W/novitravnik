...
class Addikobanka extends StatefulWidget {
  const Addikobanka({Key? key}) : super(key: key);

  @override
  _addikostate createState() => _addikostate();
}

class _addikostate extends State<Addikobanka> {
  ...
  addikobankdata data = addikobankdata();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17517219728863, 17.662883008352882),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/addiko.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 8/15:30'
                                      : (English == true)
                                          ? "Working hours: 8/15:30"
                                          : "Arbeitszeit: 8/15:30",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ive Andrića 35'
                                        : (English == true)
                                            ? "Address: Ive Andrića 35"
                                            : "die Anschrift: Ive Andrića 35",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
