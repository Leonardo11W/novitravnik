...
class Intesa extends StatefulWidget {
  const Intesa({Key? key}) : super(key: key);

  @override
  _IntesaState createState() => _IntesaState();
}

class _IntesaState extends State<Intesa> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17040754407083, 17.65670722940237),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/intesa.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 8/16:30'
                                      : (English == true)
                                          ? "Working hours: 8/16:30"
                                          : "Arbeitszeit: 8/16:30",
                                  ...
                                  RichText(
                                      text: new TextSpan(
                                          ...
                                          recognizer: new TapGestureRecognizer()
                                            ..onTap = () async {
                                              launch(
                                                  'https://www.intesasanpaolobanka.ba/');
                                            }))
                                ],
                              )),
                        ],
