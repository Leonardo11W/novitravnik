...
import 'package:novi_travnik/ostalo/banke/bankeposebno.dart';
...
class UnicreditBankomat2 extends StatefulWidget {
  const UnicreditBankomat2({Key? key}) : super(key: key);

  @override
  _UnicreditBankomat2 createState() => _UnicreditBankomat2();
}

class _UnicreditBankomat2 extends State<UnicreditBankomat2> {
  ...
  UnicreditbankomatData2 data = UnicreditbankomatData2();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17707782443389, 17.66395250455311),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/bankomati.png',
