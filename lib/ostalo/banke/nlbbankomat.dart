...
class nlbbankomat extends StatefulWidget {
  const nlbbankomat({Key? key}) : super(key: key);

  @override
  _nblbankomatState createState() => _nblbankomatState();
}

class _nblbankomatState extends State<nlbbankomat> {
  ...
  nlbbankomatData data = nlbbankomatData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17033636496983, 17.658017110073235),
  ];
