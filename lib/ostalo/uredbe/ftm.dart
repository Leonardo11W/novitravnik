...
class FTM extends StatefulWidget {
  const FTM({Key? key}) : super(key: key);

  @override
  _HteronetState createState() => _HteronetState();
}

class _HteronetState extends State<FTM> {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/ftm.png',
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ...
                                            : "die Anschrift: Stjepana Tomaševića bb",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
