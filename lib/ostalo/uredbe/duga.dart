...
class Duga extends StatefulWidget {
  const Duga({Key? key}) : super(key: key);

  @override
  _DugaState createState() => _DugaState();
}

class _DugaState extends State<Duga> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DugaData data = DugaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.171487730976935, 17.65701182048855),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/duga.png',
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ...
                                            : "die Anschrift: Ljudevita Gaja bb",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
