...
class _HteronetState extends State<Stop> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17200139252653, 17.661051526677248),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/stop.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Kralja Tvrtka 29'
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka 29"
                                            : "die Anschrift: Kralja Tvrtka 29",
