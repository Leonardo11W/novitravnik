...
import 'package:novi_travnik/ostalo/dentali/dentalidata.dart';
import 'package:novi_travnik/ostalo/ostalo.dart';

import 'package:novi_travnik/ostalo/pumpe/pumpedata.dart';
import 'package:novi_travnik/ostalo/uredbe/uredbedata.dart';
...
class Uredbe extends StatefulWidget {
  const Uredbe({Key? key}) : super(key: key);

  @override
  _UredbeState createState() => _UredbeState();
}

class _UredbeState extends State<Uredbe> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  UredbeData data = UredbeData();
