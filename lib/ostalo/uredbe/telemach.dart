...
class Telemach extends StatefulWidget {
  const Telemach({Key? key}) : super(key: key);

  @override
  _HteronetState createState() => _HteronetState();
}

class _HteronetState extends State<Telemach> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  TelemachData data = TelemachData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17133960695388, 17.660913602459473),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/telemach.png',
