...
class Vatrogasnidom extends StatefulWidget {
  const Vatrogasnidom({Key? key}) : super(key: key);

  @override
  _VatrogasnidomState createState() => _VatrogasnidomState();
}

class _VatrogasnidomState extends State<Vatrogasnidom> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  VatrogasniDomData data = VatrogasniDomData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16721159633811, 17.651966323945093),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/vatrogasni.png',
