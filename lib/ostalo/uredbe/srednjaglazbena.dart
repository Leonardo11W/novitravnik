...
class SrednjaGlazbenaSkola extends StatefulWidget {
  const SrednjaGlazbenaSkola({Key? key}) : super(key: key);

  @override
  _SrednjaGlazbenaskolaState createState() => _SrednjaGlazbenaskolaState();
}

class _SrednjaGlazbenaskolaState extends State<SrednjaGlazbenaSkola> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  SrednjaglazbenaskolaData data = SrednjaglazbenaskolaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17172041458867, 17.657879196232923),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/srednjaglazbena.png',
                            imageBuilder: (context, imageProvider) => Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          'https://photos.novitravnik.online/more/srednjaglazena.png'),
                                      fit: BoxFit.fitWidth,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Srednja Glazbena N.T."),
      ),
      body: Stack(
        children: [
          GoogleMap(
