...
class Osnovnaskola extends StatefulWidget {
  const Osnovnaskola({Key? key}) : super(key: key);

  @override
  _OsnovnaskolaState createState() => _OsnovnaskolaState();
}

class _OsnovnaskolaState extends State<Osnovnaskola> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  OsnovnaskolaData data = OsnovnaskolaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.171934308407124, 17.65835314479747),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/osnovnaskola.png',
