...
class Opcina extends StatefulWidget {
  const Opcina({Key? key}) : super(key: key);

  @override
  _OpcinaState createState() => _OpcinaState();
}

class _OpcinaState extends State<Opcina> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  OpcinaData data = OpcinaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17044489268661, 17.656856689233628),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/opcina.png',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Općina Novi Travnik"),
      ),
      body: Stack(
        children: [
          GoogleMap(
