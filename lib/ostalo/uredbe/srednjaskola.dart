...
class SrednjaSkola extends StatefulWidget {
  const SrednjaSkola({Key? key}) : super(key: key);

  @override
  _SrednjaskolaState createState() => _SrednjaskolaState();
}

class _SrednjaskolaState extends State<SrednjaSkola> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  SrednjaskolaData data = SrednjaskolaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17166628658912, 17.657752409532943),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/srednjaskola.png',
