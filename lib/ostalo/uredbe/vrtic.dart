...
class Djecjivrtic extends StatefulWidget {
  const Djecjivrtic({Key? key}) : super(key: key);

  @override
  _DjecjivrticState createState() => _DjecjivrticState();
}

class _DjecjivrticState extends State<Djecjivrtic> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  VrticData data = VrticData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17102798077178, 17.6558450400258),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/vrtic.png',
