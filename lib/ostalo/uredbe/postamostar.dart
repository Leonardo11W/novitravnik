...
class Postamostar extends StatefulWidget {
  const Postamostar({Key? key}) : super(key: key);

  @override
  _postamostarState createState() => _postamostarState();
}

class _postamostarState extends State<Postamostar> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  PostamostarData data = PostamostarData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.170432387541844, 17.657252315063577),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/posta.png',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Hrvatska pošta Mostar"),
      ),
      body: Stack(
        children: [
          GoogleMap(
