...
class Policijska extends StatefulWidget {
  const Policijska({Key? key}) : super(key: key);

  @override
  _PolicijskaState createState() => _PolicijskaState();
}

class _PolicijskaState extends State<Policijska> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  PolicijaData data = PolicijaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.173264605759314, 17.659450795383897),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/policija.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Stjepana Tomaševića 38'
                                        : (English == true)
                                            ? "Address: Stjepana Tomaševića 38"
                                            : "die Anschrift: Stjepana Tomaševića 38",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
