...
class Osnovnaglazbena extends StatefulWidget {
  const Osnovnaglazbena({Key? key}) : super(key: key);

  @override
  _OsnovnaglazbenaState createState() => _OsnovnaglazbenaState();
}

class _OsnovnaglazbenaState extends State<Osnovnaglazbena> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  OsnovnaglazbenaData data = OsnovnaglazbenaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17117050516021, 17.655628743804197),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/osnovnaglazbena.png',
