...
class Domkulture extends StatefulWidget {
  const Domkulture({Key? key}) : super(key: key);

  @override
  _DomkultureState createState() => _DomkultureState();
}

class _DomkultureState extends State<Domkulture> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DomkultureData data = DomkultureData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.170087052078976, 17.65523663498844),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/domkulture.png',
