...
class Spajk extends StatefulWidget {
  const Spajk({Key? key}) : super(key: key);

  @override
  SpajkState createState() => SpajkState();
}

class SpajkState extends State<Spajk> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  SpajkData data = SpajkData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17136826217146, 17.66097593903684),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/spyk.png',
