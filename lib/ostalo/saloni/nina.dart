...
class Nina extends StatefulWidget {
  const Nina({Key? key}) : super(key: key);

  @override
  NinaState createState() => NinaState();
}

class NinaState extends State<Nina> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.174501520919804, 17.662607962254157),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/nina.png',
