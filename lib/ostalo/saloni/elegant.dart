...
class Elegant extends StatefulWidget {
  const Elegant({Key? key}) : super(key: key);

  @override
  ElegantState createState() => ElegantState();
}

class ElegantState extends State<Elegant> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  ElegantData data = ElegantData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.172476284487026, 17.66051663697429),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/elegant.png',
