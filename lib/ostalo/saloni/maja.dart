...
class Maja extends StatefulWidget {
  const Maja({Key? key}) : super(key: key);

  @override
  MajaState createState() => MajaState();
}

class MajaState extends State<Maja> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  MajaData data = MajaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17591871566896, 17.664556430591784),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/maja.png',
