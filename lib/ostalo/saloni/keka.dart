...
class Keka extends StatefulWidget {
  const Keka({Key? key}) : super(key: key);

  @override
  KekaState createState() => KekaState();
}

class KekaState extends State<Keka> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  KekaData data = KekaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17279749777492, 17.66122579535168),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/keka.png',
