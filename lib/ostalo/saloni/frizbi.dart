...
class Frizbi extends StatefulWidget {
  const Frizbi({Key? key}) : super(key: key);

  @override
  FrizbiState createState() => FrizbiState();
}

class FrizbiState extends State<Frizbi> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  FrizbiData data = FrizbiData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.174349847841825, 17.66344494542566),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/frizbi.png',
