...
class Miro extends StatefulWidget {
  const Miro({Key? key}) : super(key: key);

  @override
  MiroState createState() => MiroState();
}

class MiroState extends State<Miro> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  NinaData data = NinaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.175393549404035, 17.663419728448837),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/miro.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 9/13 15/18'
                                      : (English == true)
                                          ? "Working hours: 9/13 15/18"
                                          : "Arbeitszeit: 9/13 15/18",
