...
class LaDiva extends StatefulWidget {
  const LaDiva({Key? key}) : super(key: key);

  @override
  _LaVidaState createState() => _LaVidaState();
}

class _LaVidaState extends State<LaDiva> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  LaDivaData data = LaDivaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17353593747242, 17.663711398127177),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/lavida.png',
