...
class Cuperak extends StatefulWidget {
  const Cuperak({Key? key}) : super(key: key);

  @override
  CuperakState createState() => CuperakState();
}

class CuperakState extends State<Cuperak> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  CuperakData data = CuperakData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17245684039236, 17.660953559619735),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/cuperak.png',
