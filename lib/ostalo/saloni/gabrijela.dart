...
import 'package:novi_travnik/ostalo/saloni/saloniposebno.dart';
...
class Gabrijela extends StatefulWidget {
  const Gabrijela({Key? key}) : super(key: key);

  @override
  GabrijelaState createState() => GabrijelaState();
}

class GabrijelaState extends State<Gabrijela> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  GabeData data = GabeData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17437061142184, 17.663707601169822),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/gabrijela.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Stjepana Radića 9'
                                        : (English == true)
                                            ? "Address: Stjepana Radića 9"
                                            : "die Anschrift: Stjepana Radića 9",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
