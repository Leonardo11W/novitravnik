...
import 'package:novi_travnik/ostalo/sport/klubovi/klubovidata.dart';
...
class Klubovi extends StatefulWidget {
  const Klubovi({Key? key}) : super(key: key);

  @override
  _PumpeState createState() => _PumpeState();
}

class _PumpeState extends State<Klubovi> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  KluboviData data = KluboviData();
