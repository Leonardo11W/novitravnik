...
class FitnessFamily extends StatefulWidget {
  const FitnessFamily({Key? key}) : super(key: key);

  @override
  _FitnessState createState() => _FitnessState();
}

class _FitnessState extends State<FitnessFamily> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17153577666188, 17.661115055275715),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/fitnessfamily.png',
