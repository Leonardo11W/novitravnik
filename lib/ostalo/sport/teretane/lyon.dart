...
class LionGym extends StatefulWidget {
  const LionGym({Key? key}) : super(key: key);

  @override
  _LionGymState createState() => _LionGymState();
}

class _LionGymState extends State<LionGym> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  LionGymData data = LionGymData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17141027811654, 17.658529826244212),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/powergym.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ljudevita Gaja 22/A'
                                        : (English == true)
                                            ? "Address: Ljudevita Gaja 22/A"
                                            : "die Anschrift: Ljudevita Gaja 22/A",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
