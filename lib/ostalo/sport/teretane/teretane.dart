...
import 'package:novi_travnik/ostalo/sport/teretane/teretanedata.dart';
...
class Teretane extends StatefulWidget {
  const Teretane({Key? key}) : super(key: key);

  @override
  _TeretaneState createState() => _TeretaneState();
}

class _TeretaneState extends State<Teretane> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  TeretaneData data = TeretaneData();
