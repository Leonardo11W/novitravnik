...
class LuganGym extends StatefulWidget {
  const LuganGym({Key? key}) : super(key: key);

  @override
  _LuganGymState createState() => _LuganGymState();
}

class _LuganGymState extends State<LuganGym> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.167902678910465, 17.651116880718345),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/lugangym.png',
