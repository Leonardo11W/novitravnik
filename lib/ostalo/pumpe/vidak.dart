...
class Vidak extends StatefulWidget {
  const Vidak({Key? key}) : super(key: key);

  @override
  _VidakState createState() => _VidakState();
}

class _VidakState extends State<Vidak> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  VidakData data = VidakData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.18379246627635, 17.67139364786249),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/vidak.png',
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ? "Address: Stojkovići bb"
                                            : "die Anschrift: Stojkovići bb",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
