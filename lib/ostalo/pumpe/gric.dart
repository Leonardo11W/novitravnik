...
class Gric extends StatefulWidget {
  const Gric({Key? key}) : super(key: key);

  @override
  _GricState createState() => _GricState();
}

class _GricState extends State<Gric> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  GricData data = GricData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.1689122616796, 17.655510443688176),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/gric.png',
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ...
                                            : "die Anschrift: Ruđera Boškovića bb",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
