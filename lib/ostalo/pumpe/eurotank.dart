...
import 'package:novi_travnik/ostalo/pumpe/pumpeposebno.dart';
...
class Eurotank extends StatefulWidget {
  const Eurotank({Key? key}) : super(key: key);

  @override
  _EurotankState createState() => _EurotankState();
}

class _EurotankState extends State<Eurotank> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  EurotankData data = EurotankData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.18028185815911, 17.669782904804247),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/eurotank.png',
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Novi Travnik'
                                        : (English == true)
                                            ? "Address: Novi Travnik"
                                            : "die Anschrift: Novi Travnik",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
