...
class Ina extends StatefulWidget {
  const Ina({Key? key}) : super(key: key);

  @override
  _InaState createState() => _InaState();
}

class _InaState extends State<Ina> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  InaData data = InaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17897192272741, 17.665753503134294),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/ina.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Katarine Kotromanič'
                                        : (English == true)
                                            ? "Address: Katarine Kotromanič"
                                            : "die Anschrift: Katarine Kotromanič",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
