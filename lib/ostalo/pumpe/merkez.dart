...
class Merkez extends StatefulWidget {
  const Merkez({Key? key}) : super(key: key);
...
class _MerkezState extends State<Merkez> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.165952094030075, 17.650657975317028),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/samoposluga/merkez.png',
