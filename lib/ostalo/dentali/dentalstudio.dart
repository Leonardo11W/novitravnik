...
class DentalStudio extends StatefulWidget {
  const DentalStudio({Key? key}) : super(key: key);

  @override
  _DentalStudioState createState() => _DentalStudioState();
}

class _DentalStudioState extends State<DentalStudio> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DentalStudioData data = DentalStudioData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17084035714651, 17.658149965053944),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/dentalstudio.png',
