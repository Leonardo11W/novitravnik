...
class DentalMirza extends StatefulWidget {
  const DentalMirza({Key? key}) : super(key: key);

  @override
  _DentalMirzaState createState() => _DentalMirzaState();
}

class _DentalMirzaState extends State<DentalMirza> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  MirzaData data = MirzaData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17116182921657, 17.658809177884734),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/mirza.png',
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Kralja Tvrtka 23'
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka 23"
                                            : "die Anschrift: Kralja Tvrtka 23",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
