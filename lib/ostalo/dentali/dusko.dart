...
class Dusko extends StatefulWidget {
  const Dusko({Key? key}) : super(key: key);

  @override
  _DuskoState createState() => _DuskoState();
}

class _DuskoState extends State<Dusko> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.174542595410365, 17.662514625112824),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/dusko.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 9/12 16/18'
                                      : (English == true)
                                          ? "Working hours: 9/12 16/18"
                                          : "Arbeitszeit: 9/12 16/18",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ljudevita Gaja 57'
                                        : (English == true)
                                            ? "Address: Ljudevita Gaja 57"
                                            : "die Anschrift: Ljudevita Gaja 57",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
