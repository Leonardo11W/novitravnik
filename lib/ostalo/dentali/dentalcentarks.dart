...
class DentalCentarKS extends StatefulWidget {
  const DentalCentarKS({Key? key}) : super(key: key);

  @override
  _DentalCentarKSState createState() => _DentalCentarKSState();
}

class _DentalCentarKSState extends State<DentalCentarKS> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DentalCentarData data = DentalCentarData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16872143271498, 17.653514184012806),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/more/dentalcentarks.png',
