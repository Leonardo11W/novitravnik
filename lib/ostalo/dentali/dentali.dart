...
class Dentali extends StatefulWidget {
  const Dentali({Key? key}) : super(key: key);

  @override
  _DentaliState createState() => _DentaliState();
}

class _DentaliState extends State<Dentali> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DentaliData data = DentaliData();
