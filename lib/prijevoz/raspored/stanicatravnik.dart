...
import 'package:novi_travnik/prijevoz/raspored/stanicedata.dart';

import 'package:novi_travnik/search.dart';

import 'package:geolocator/geolocator.dart';

class Stanicatravnik extends StatefulWidget {
  const Stanicatravnik({Key? key}) : super(key: key);

  @override
  _StaniceState createState() => _StaniceState();
}

class _StaniceState extends State<Stanicatravnik> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  StanicaTravnikData data = StanicaTravnikData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.22722789708058, 17.65756043468433),
  ];
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Stanična, Travnik 72270'
                                        : (English == true)
                                            ? "Address: Stanična, Travnik 72270"
                                            : "die Anschrift: Stanična, Travnik 72270",
