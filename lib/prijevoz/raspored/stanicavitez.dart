...
class StanicaVitez extends StatefulWidget {
  const StanicaVitez({Key? key}) : super(key: key);

  @override
  _StaniceState createState() => _StaniceState();
}

class _StaniceState extends State<StanicaVitez> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  StanicaVitezData data = StanicaVitezData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.1531846256963, 17.79181089797454),
  ];
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Kralja Tvrtka, Vitez 72250'
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka, Vitez 72250"
                                            : "die Anschrift: Kralja Tvrtka, Vitez 72250",
