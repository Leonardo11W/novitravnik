...
class Stanicanovi extends StatefulWidget {
  const Stanicanovi({Key? key}) : super(key: key);

  @override
  _StaniceState createState() => _StaniceState();
}

class _StaniceState extends State<Stanicanovi> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  StanicanoviData data = StanicanoviData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16652913605547, 17.651071931370453),
  ];
