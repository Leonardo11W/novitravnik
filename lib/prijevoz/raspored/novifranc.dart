...
class Novifranc extends StatefulWidget {
  const Novifranc({Key? key}) : super(key: key);

  @override
  _StaniceState createState() => _StaniceState();
}

class _StaniceState extends State<Novifranc> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  GradskastanicaData data = GradskastanicaData();
