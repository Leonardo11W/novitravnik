...
class _IceState extends State<Ice> {
  ...
  Future _getTheDistance() async {
    ...
    for (int i = 0; i < data.icici.length; i++) {
      double storelat = data.icici[i]['lat'];
      double storelng = data.icici[i]['lng'];
      ...
      data.icici[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.169984167129336, 17.657359228667595),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/lounge/ice.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.icici[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
