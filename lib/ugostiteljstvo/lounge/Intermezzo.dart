...
import 'package:novi_travnik/ugostiteljstvo/lounge/posebnolounge.dart';
import 'package:novi_travnik/ugostiteljstvo/ugostiteljstvo.dart';

class Intermezzo extends StatefulWidget {
  const Intermezzo({Key? key}) : super(key: key);

  @override
  _IntermezzoState createState() => _IntermezzoState();
}

class _IntermezzoState extends State<Intermezzo> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  IntermezzoData data = IntermezzoData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.mecizi.length; i++) {
      double storelat = data.mecizi[i]['lat'];
      double storelng = data.mecizi[i]['lng'];
      ...
      data.mecizi[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16800817321762, 17.65000118465714),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/lounge/intermezzo.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.mecizi[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
