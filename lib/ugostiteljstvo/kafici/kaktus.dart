...
class Kaktus extends StatefulWidget {
  const Kaktus({Key? key}) : super(key: key);

  @override
  _KaktusState createState() => _KaktusState();
}

class _KaktusState extends State<Kaktus> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  KaktusData data = KaktusData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.kaktusi.length; i++) {
      double storelat = data.kaktusi[i]['lat'];
      double storelng = data.kaktusi[i]['lng'];
      ...
      data.kaktusi[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.168397381618796, 17.653328241729213),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/kaktus.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.kaktusi[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
