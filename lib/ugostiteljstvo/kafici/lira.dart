...
class Lira extends StatefulWidget {
  const Lira({Key? key}) : super(key: key);

  @override
  _LiraState createState() => _LiraState();
}

class _LiraState extends State<Lira> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16970070222539, 17.656491546200925),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/noimage.png',
