...
class Cortado extends StatefulWidget {
  const Cortado({Key? key}) : super(key: key);

  @override
  _CortadoState createState() => _CortadoState();
}

class _CortadoState extends State<Cortado> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  CortadoData data = CortadoData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.kortadice.length; i++) {
      double storelat = data.kortadice[i]['lat'];
      double storelng = data.kortadice[i]['lng'];
      ...
      data.kortadice[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17055121084639, 17.658490664396826),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/cortado.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.kortadice[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
