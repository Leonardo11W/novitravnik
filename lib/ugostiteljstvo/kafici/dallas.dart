...
class Dallas extends StatefulWidget {
  const Dallas({Key? key}) : super(key: key);

  @override
  _DallasState createState() => _DallasState();
}

class _DallasState extends State<Dallas> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  DallasData data = DallasData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.dalasi.length; i++) {
      double storelat = data.dalasi[i]['lat'];
      double storelng = data.dalasi[i]['lng'];
      ...
      data.dalasi[i]['distance'] = (distance!);
      setState(() {});
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/dallas.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.dalasi[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
