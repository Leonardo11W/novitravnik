...
class _StarState extends State<Star> {
  ...
  Future _getTheDistance() async {
    ...
    for (int i = 0; i < data.starici.length; i++) {
      double storelat = data.starici[i]['lat'];
      double storelng = data.starici[i]['lng'];
      ...
      data.starici[i]['distance'] = (distance!);
      setState(() {});
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/star.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.starici[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
