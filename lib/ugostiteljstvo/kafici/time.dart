...
class _TimeState extends State<Time> {
  ...
  Future _getTheDistance() async {
    ...
    for (int i = 0; i < data.timici.length; i++) {
      double storelat = data.timici[i]['lat'];
      double storelng = data.timici[i]['lng'];
      ...
      data.timici[i]['distance'] = (distance!);
      setState(() {});
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/time.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.timici[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
