...
class _AuroraState extends State<Aurora> {
  ...
  final List<LatLng> _latLang = [
    LatLng(44.173064951887405, 17.662650753938692),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/aurora.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 06:30/23'
                                      : (English == true)
                                          ? "Working hours: 06:30/23"
                                          : "Arbeitszeit: 06:30/23",
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  RichText(
                                      text: new TextSpan(
                                          text: 'caffe-aurora.business.site',
                                          style: TextStyle(
                                              color: (Click == false)
                                                  ? Colors.white
                                                  : Colors.black),
                                          recognizer: new TapGestureRecognizer()
                                            ..onTap = () async {
                                              launch(
                                                  'https://caffe-aurora.business.site/');
                                            }))
                                ],
                              )),
                        ],
