...
class Lotos extends StatefulWidget {
  const Lotos({Key? key}) : super(key: key);

  @override
  _LotosState createState() => _LotosState();
}

class _LotosState extends State<Lotos> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  LotosData data = LotosData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.lotosice.length; i++) {
      double storelat = data.lotosice[i]['lat'];
      double storelng = data.lotosice[i]['lng'];
      ...
      data.lotosice[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.170790475910515, 17.659082871788968),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/lotos.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.lotosice[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
