...
class _CodeState extends State<Code> {
  ...
  Future _getTheDistance() async {
    ...
    for (int i = 0; i < data.codici.length; i++) {
      double storelat = data.codici[i]['lat'];
      double storelng = data.codici[i]['lng'];
      ...
      data.codici[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17348048754259, 17.66287069506971),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/code.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.codici[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Ive Andrića 15'
                                        : (English == true)
                                            ? "Address: Ive Andrića 15"
                                            : "die Anschrift: Ive Andrića 15",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
