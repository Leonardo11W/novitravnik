...
class Galaksija extends StatefulWidget {
  const Galaksija({Key? key}) : super(key: key);

  @override
  _GalaksijaState createState() => _GalaksijaState();
}

class _GalaksijaState extends State<Galaksija> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  GalaksijaData data = GalaksijaData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.galaksici.length; i++) {
      double storelat = data.galaksici[i]['lat'];
      double storelng = data.galaksici[i]['lng'];
      ...
      data.galaksici[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.168455759358324, 17.647983837879526),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/galaksija.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.galaksici[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
