...
class _CustomMarkerInfoWindowState extends State<Studio> {
  ...
  Future _getTheDistance() async {
    ...
    for (int i = 0; i < data.studijice.length; i++) {
      double storelat = data.studijice[i]['lat'];
      double storelng = data.studijice[i]['lng'];
      ...
      data.studijice[i]['distance'] = (distance!);
      setState(() {});
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/studio.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.studijice[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
                          ...
                          Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ? 'Adresa: Kralja Tvrtka 14A'
                                        : (English == true)
                                            ? "Address: Kralja Tvrtka 14A"
                                            : "die Anschrift: Kralja Tvrtka 14A",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
