...
class Balkan extends StatefulWidget {
  const Balkan({Key? key}) : super(key: key);

  @override
  _BalkanState createState() => _BalkanState();
}

class _BalkanState extends State<Balkan> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  BalkanData data = BalkanData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.balkanci.length; i++) {
      double storelat = data.balkanci[i]['lat'];
      double storelng = data.balkanci[i]['lng'];
      ...
      data.balkanci[i]['distance'] = (distance!);
      setState(() {});
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/kafici/balkan.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${data.balkanci[0]['distance'].round()} m udaljeno",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ? "Address: Ive Andrića 33"
                                            : "die Anschrift: Ive Andrića 33",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
