...
class Galija extends StatefulWidget {
  const Galija({Key? key}) : super(key: key);

  @override
  _GalijaState createState() => _GalijaState();
}

class _GalijaState extends State<Galija> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  GalijaData data = GalijaData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.galiji.length; i++) {
      double storelat = data.galiji[i]['lat'];
      double storelng = data.galiji[i]['lng'];
      ...
      data.galiji[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.177792227376735, 17.664740898117476),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/restoran/galija.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  (BHS == true)
                                      ? "${data.galiji[0]['distance'].round()} m udaljeno"
                                      : (English == true)
                                          ? "${data.galiji[0]['distance'].round()} m away"
                                          : "${data.galiji[0]['distance'].round()} m weg",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 6:30/00'
                                      : (English == true)
                                          ? "Working hours: 6:30/00"
                                          : "Arbeitszeit: 6:30/00",
