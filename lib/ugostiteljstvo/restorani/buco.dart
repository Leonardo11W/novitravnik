...
class Buco extends StatefulWidget {
  const Buco({Key? key}) : super(key: key);

  @override
  _MilanoState createState() => _MilanoState();
}

class _MilanoState extends State<Buco> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  BucoData data = BucoData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.16949822131104, 17.656282157181888),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/buco.png',
