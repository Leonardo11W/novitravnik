...
import 'package:novi_travnik/ugostiteljstvo/restorani/restorandata.dart';
...
class _RestoranState extends State<Restoran> {
  ...
  RestoranData data = RestoranData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.restorani.length; i++) {
      double storelat = data.restorani[i]['lat'];
      double storelng = data.restorani[i]['lng'];
      ...
      data.restorani[i]['distance'] = (distance!);
      setState(() {});
    }
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.builder(
            itemCount: data.restorani.length,
                  ...
                  onTap: () {
                    {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  data.restorani[index]['navigation']));
                    }
                  },
                  child: Container(
                      ...
                      children: [
                        Container(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: data.restorani[index]['image'],
                            fit: BoxFit.fill,
                          ),
                        ),
                        SizedBox(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${data.restorani[index]['distance'].round()} m udaljeno",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.white,
                              ),
