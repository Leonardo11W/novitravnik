...
class Oskar extends StatefulWidget {
  const Oskar({Key? key}) : super(key: key);

  @override
  _MilanoState createState() => _MilanoState();
}

class _MilanoState extends State<Oskar> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  OskarData data = OskarData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.agavi.length; i++) {
      double storelat = data.agavi[i]['lat'];
      double storelng = data.agavi[i]['lng'];
      ...
      data.agavi[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.179385955884705, 17.66955010737737),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/jos/oskar.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  (BHS == true)
                                      ? "${data.agavi[0]['distance'].round()} m udaljeno"
                                      : (English == true)
                                          ? "${data.agavi[0]['distance'].round()} m away"
                                          : "${data.agavi[0]['distance'].round()} m weg",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  (BHS == true)
                                      ? 'Radno vrijeme: 7:30/23'
                                      : (English == true)
                                          ? "Working hours: 7:30/23"
                                          : "Arbeitszeit: 7:30/23",
