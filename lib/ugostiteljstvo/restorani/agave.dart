...
class Agave extends StatefulWidget {
  const Agave({Key? key}) : super(key: key);

  @override
  _AgaveState createState() => _AgaveState();
}

class _AgaveState extends State<Agave> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  AgaveData data = AgaveData();
  ...
  final List<LatLng> _latLang = [
    LatLng(44.175621065342725, 17.66382321408379),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/restoran/agave.png',
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    (BHS == true)
                                        ...
                                        : (English == true)
                                            ? "Address: Stjepana Radića 20"
                                            : "die Anschrift: Stjepana Radića 20",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: (Click == false)
                                            ? Colors.white
