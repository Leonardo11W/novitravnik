...
class Bajra extends StatefulWidget {
  ...
  @override
  _BajraState createState() => _BajraState();
}

class _BajraState extends State<Bajra> {
  Position? _currentUserPosition;
  double? distanceImMeter = 0.0;
  BajraData data = BajraData();
  Future _getTheDistance() async {
    _currentUserPosition = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high);

    for (int i = 0; i < data.bajri.length; i++) {
      double storelat = data.bajri[i]['lat'];
      double storelng = data.bajri[i]['lng'];
      ...
      data.bajri[i]['distance'] = (distance!);
      setState(() {});
    }
  }
  ...
  final List<LatLng> _latLang = [
    LatLng(44.17004684887674, 17.653799654074298),
  ];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CachedNetworkImage(
                            imageUrl:
                                'https://photos.novitravnik.online/restoran/bajra.png',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  (BHS == true)
                                      ? "${data.bajri[0]['distance'].round()} m udaljeno"
                                      : (English == true)
                                          ? "${data.bajri[0]['distance'].round()} m away"
                                          : "${data.bajri[0]['distance'].round()} m weg",
                                  maxLines: 1,
                                  overflow: TextOverflow.fade,
                                  softWrap: false,
                                  textAlign: TextAlign.center,
